...
namespace __tests__.Integration {
    ...
    public class IntlAutocompletionsApiTests : IDisposable
    {
        ...
        public IntlAutocompletionsApiTests()
        {
            ...
            intlAutocompletionWritable.setAddressPrefix("340 Wat");
            intlAutocompletionWritable.setCity("Summerside");
            intlAutocompletionWritable.setState("Prince Edward Island");
            intlAutocompletionWritable.setZipCode("C1N 1C4");
            intlAutocompletionWritable.setCountry(CountryExtended.CA);
        }

        public void Dispose() {}

        [Test]
        [Ignore("Ignore until parser fixed")]
