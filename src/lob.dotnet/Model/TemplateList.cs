...
namespace lob.dotnet.Model
{
    ...
    public partial class TemplateList : IEquatable<TemplateList>, IValidatableObject
    {
        ...
        public TemplateList(List<Template> data = default(List<Template>), string _object = default(string), string nextUrl = default(string), string previousUrl = default(string), int count = default(int), int totalCount = default(int))
        {
            this.Data = data;
            this.Object = _object;
