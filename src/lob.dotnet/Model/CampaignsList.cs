...
namespace lob.dotnet.Model
{
    ...
    /// CampaignsList
    /// </summary>
    [DataContract(Name = "campaigns_list")]
    public partial class CampaignsList : IEquatable<CampaignsList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignsList" /> class.
        /// </summary>
        /// <param name="data">list of campaigns.</param>
        ...
        public CampaignsList(List<Campaign> data = default(List<Campaign>), string _object = default(string), string nextUrl = default(string), string previousUrl = default(string), int count = default(int), int totalCount = default(int))
        {
            this.Data = data;
            this.Object = _object;
        ...
        {
            return this.Equals(input as CampaignsList);
        }

        /// <summary>
        /// Returns true if CampaignsList instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignsList input)
        {
            if (input == null)
            {
                return false;
