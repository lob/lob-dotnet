...
namespace lob.dotnet.Model
{
    ...
    /// BuckslipOrder
    /// </summary>
    [DataContract(Name = "buckslip_order")]
    public partial class BuckslipOrder : IEquatable<BuckslipOrder>, IValidatableObject
    {
        /// <summary>
        /// The status of the buckslip order.
        /// </summary>
        /// <value>The status of the buckslip order.</value>
        ...
        /// <param name="id">Unique identifier prefixed with &#x60;bo_&#x60;..</param>
        /// <param name="buckslipId">Unique identifier prefixed with &#x60;bck_&#x60;..</param>
        /// <param name="status">The status of the buckslip order..</param>
        /// <param name="quantityOrdered">The quantity of buckslips ordered. (default to 0M).</param>
        /// <param name="unitPrice">The unit price for the buckslip order. (default to 0M).</param>
        /// <param name="inventory">The inventory of the buckslip order. (default to 0M).</param>
        ...
        /// <param name="expectedAvailabilityDate">The fixed deadline for the buckslips to be printed..</param>
        public BuckslipOrder(DateTime dateCreated = default(DateTime), DateTime dateModified = default(DateTime), bool deleted = default(bool), string _object = default(string), string id = default(string), string buckslipId = default(string), StatusEnum? status = default(StatusEnum?), decimal quantityOrdered = 0M, decimal unitPrice = 0M, decimal inventory = 0M, string cancelledReason = default(string), DateTime availabilityDate = default(DateTime), DateTime expectedAvailabilityDate = default(DateTime))
        {
            ...
            if (_object == null)
            {
                throw new ArgumentNullException("_object is a required property for BuckslipOrder and cannot be null");
            }
            this.Object = _object;
        ...
        /// </summary>
        /// <value>Unique identifier prefixed with &#x60;bo_&#x60;.</value>
        ...
        [DataMember(Name = "buckslip_id", EmitDefaultValue = false)]
        public string BuckslipId { get; set; }

        /// <summary>
        /// The quantity of buckslips ordered.
        /// </summary>
        /// <value>The quantity of buckslips ordered.</value>
        ...
        /// </summary>
        /// <value>The unit price for the buckslip order.</value>
        ...
        /// </summary>
        /// <value>The inventory of the buckslip order.</value>
        ...
        /// </summary>
        /// <value>The fixed deadline for the buckslips to be printed.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BuckslipId: ").Append(BuckslipId).Append("\n");
        ...
        {
            return this.Equals(input as BuckslipOrder);
        }

        /// <summary>
        /// Returns true if BuckslipOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of BuckslipOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BuckslipOrder input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.BuckslipId == input.BuckslipId ||
                    (this.BuckslipId != null &&
                    this.BuckslipId.Equals(input.BuckslipId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BuckslipId != null)
                {
                    hashCode = (hashCode * 59) + this.BuckslipId.GetHashCode();
                }
        ...
        {
            // Id (string) pattern
            Regex regexId = new Regex(@"^bo_[a-zA-Z0-9]+$", RegexOptions.CultureInvariant);
            if (false == regexId.Match(this.Id).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Id, must match a pattern of " + regexId, new [] { "Id" });
            }

            // BuckslipId (string) pattern
            Regex regexBuckslipId = new Regex(@"^bck_[a-zA-Z0-9]+$", RegexOptions.CultureInvariant);
            if (false == regexBuckslipId.Match(this.BuckslipId).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for BuckslipId, must match a pattern of " + regexBuckslipId, new [] { "BuckslipId" });
            }
