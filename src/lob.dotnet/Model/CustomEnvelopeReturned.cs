...
namespace lob.dotnet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "custom_envelope_returned")]
    public partial class CustomEnvelopeReturned : IEquatable<CustomEnvelopeReturned>, IValidatableObject
    {
        /// <summary>
        /// Defines Object
        /// </summary>
        ...
        protected CustomEnvelopeReturned() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomEnvelopeReturned" /> class.
        /// </summary>
        ...
        public CustomEnvelopeReturned(string id = default(string), string url = default(string), ObjectEnum _object = ObjectEnum.Envelope)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for CustomEnvelopeReturned and cannot be null");
            }
            this.Id = id;
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for CustomEnvelopeReturned and cannot be null");
            }
            this.Url = url;
            this.Object = _object;
        }
        ...
        {
            return this.Equals(input as CustomEnvelopeReturned);
        }

        /// <summary>
        /// Returns true if CustomEnvelopeReturned instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomEnvelopeReturned to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomEnvelopeReturned input)
        {
            if (input == null)
            {
                return false;
