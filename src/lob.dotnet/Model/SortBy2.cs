...
namespace lob.dotnet.Model
{
    ...
    /// SortBy2
    /// </summary>
    [DataContract(Name = "sort_by_2")]
    public partial class SortBy2 : IEquatable<SortBy2>, IValidatableObject
    {
        /// <summary>
        /// Defines DateCreated
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SortBy2" /> class.
        /// </summary>
        /// <param name="dateCreated">dateCreated.</param>
        /// <param name="sendDate">sendDate.</param>
        public SortBy2(DateCreatedEnum? dateCreated = default(DateCreatedEnum?), SendDateEnum? sendDate = default(SendDateEnum?))
        {
        ...
        {
            return this.Equals(input as SortBy2);
        }

        /// <summary>
        /// Returns true if SortBy2 instances are equal
        /// </summary>
        /// <param name="input">Instance of SortBy2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SortBy2 input)
        {
            if (input == null)
            {
                return false;
