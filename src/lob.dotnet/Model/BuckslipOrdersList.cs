...
namespace lob.dotnet.Model
{
    ...
    /// BuckslipOrdersList
    /// </summary>
    [DataContract(Name = "buckslip_orders_list")]
    public partial class BuckslipOrdersList : IEquatable<BuckslipOrdersList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BuckslipOrdersList" /> class.
        /// </summary>
        ...
        public BuckslipOrdersList(string _object = default(string), string nextUrl = default(string), string previousUrl = default(string), int count = default(int), int totalCount = default(int))
        {
            this.Object = _object;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BuckslipOrdersList {\n");
        ...
        {
            return this.Equals(input as BuckslipOrdersList);
        }

        /// <summary>
        /// Returns true if BuckslipOrdersList instances are equal
        /// </summary>
        /// <param name="input">Instance of BuckslipOrdersList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BuckslipOrdersList input)
        {
            if (input == null)
            {
                return false;
