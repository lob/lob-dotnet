...
namespace lob.dotnet.Model
{
    ...
    /// CampaignWritable
    /// </summary>
    [DataContract(Name = "campaign_writable")]
    public partial class CampaignWritable : IEquatable<CampaignWritable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignWritable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignWritable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignWritable" /> class.
        /// </summary>
        ...
        public CampaignWritable(string billingGroupId = default(string), string name = default(string), string description = default(string), CmpScheduleType scheduleType = default(CmpScheduleType), DateTime? targetDeliveryDate = default(DateTime?), DateTime? sendDate = default(DateTime?), int? cancelWindowCampaignMinutes = default(int?), Dictionary<string, string> metadata = default(Dictionary<string, string>), CmpUseType useType = default(CmpUseType), bool autoCancelIfNcoa = default(bool))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CampaignWritable and cannot be null");
            }
            this.Name = name;
            // to ensure "scheduleType" is required (not null)
            if (scheduleType == null)
            {
                throw new ArgumentNullException("scheduleType is a required property for CampaignWritable and cannot be null");
            }
            this.ScheduleType = scheduleType;
            // to ensure "useType" is required (not null)
            if (useType == null)
            {
                throw new ArgumentNullException("useType is a required property for CampaignWritable and cannot be null");
            }
        ...
        {
            return this.Equals(input as CampaignWritable);
        }

        /// <summary>
        /// Returns true if CampaignWritable instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignWritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignWritable input)
        {
            if (input == null)
            {
                return false;
