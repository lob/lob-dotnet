...
namespace lob.dotnet.Model
{
    ...
    public partial class BankAccountList : IEquatable<BankAccountList>, IValidatableObject
    {
        ...
        public BankAccountList(List<BankAccount> data = default(List<BankAccount>), string _object = default(string), string nextUrl = default(string), string previousUrl = default(string), int count = default(int), int totalCount = default(int))
        {
            this.Data = data;
            this.Object = _object;
