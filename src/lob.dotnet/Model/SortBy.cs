...
namespace lob.dotnet.Model
{
    ...
    /// SortBy
    /// </summary>
    [DataContract(Name = "sort_by")]
    public partial class SortBy : IEquatable<SortBy>, IValidatableObject
    {
        /// <summary>
        /// Defines DateCreated
        /// </summary>
        ...
        {
            return this.Equals(input as SortBy);
        }

        /// <summary>
        /// Returns true if SortBy instances are equal
        /// </summary>
        /// <param name="input">Instance of SortBy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SortBy input)
        {
            if (input == null)
            {
                return false;
