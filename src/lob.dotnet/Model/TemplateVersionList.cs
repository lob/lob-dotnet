...
namespace lob.dotnet.Model
{
    ...
    /// TemplateVersionList
    /// </summary>
    [DataContract(Name = "template_version_list")]
    public partial class TemplateVersionList : IEquatable<TemplateVersionList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateVersionList" /> class.
        /// </summary>
        /// <param name="data">list of template versions.</param>
        ...
        public TemplateVersionList(List<TemplateVersion> data = default(List<TemplateVersion>), string _object = default(string), string nextUrl = default(string), string previousUrl = default(string), int count = default(int), int totalCount = default(int))
        {
            this.Data = data;
            this.Object = _object;
        ...
        /// </summary>
        /// <value>list of template versions</value>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public List<TemplateVersion> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TemplateVersionList {\n");
        ...
        {
            return this.Equals(input as TemplateVersionList);
        }

        /// <summary>
        /// Returns true if TemplateVersionList instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateVersionList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateVersionList input)
        {
            if (input == null)
            {
                return false;
