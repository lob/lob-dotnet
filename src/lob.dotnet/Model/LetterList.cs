...
namespace lob.dotnet.Model
{
    ...
    /// LetterList
    /// </summary>
    [DataContract(Name = "letter_list")]
    public partial class LetterList : IEquatable<LetterList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LetterList" /> class.
        /// </summary>
        /// <param name="data">list of letters.</param>
        ...
        public LetterList(List<Letter> data = default(List<Letter>), string _object = default(string), string nextUrl = default(string), string previousUrl = default(string), int count = default(int), int totalCount = default(int))
        {
            this.Data = data;
            this.Object = _object;
        ...
        {
            return this.Equals(input as LetterList);
        }

        /// <summary>
        /// Returns true if LetterList instances are equal
        /// </summary>
        /// <param name="input">Instance of LetterList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LetterList input)
        {
            if (input == null)
            {
                return false;
