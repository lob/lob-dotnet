...
namespace lob.dotnet.Model
{
    ...
    /// AddressList
    /// </summary>
    [DataContract(Name = "address_list")]
    public partial class AddressList : IEquatable<AddressList>, IValidatableObject
    {
        /// <summary>
        ...
        public AddressList(List<Address> data = default(List<Address>), string _object = default(string), string nextUrl = default(string), string previousUrl = default(string), int count = default(int), int totalCount = default(int))
        {
            this.Data = data;
            this.Object = _object;
        ...
        {
            return this.Equals(input as AddressList);
        }

        /// <summary>
        /// Returns true if AddressList instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressList input)
        {
            if (input == null)
            {
                return false;
