...
namespace lob.dotnet.Model
{
    ...
    /// SortBy3
    /// </summary>
    [DataContract(Name = "sort_by_3")]
    public partial class SortBy3 : IEquatable<SortBy3>, IValidatableObject
    {
        /// <summary>
        /// Defines DateCreated
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SortBy3" /> class.
        /// </summary>
        /// <param name="dateCreated">dateCreated.</param>
        /// <param name="sendDate">sendDate.</param>
        public SortBy3(DateCreatedEnum? dateCreated = default(DateCreatedEnum?), SendDateEnum? sendDate = default(SendDateEnum?))
        {
        ...
        {
            return this.Equals(input as SortBy3);
        }

        /// <summary>
        /// Returns true if SortBy3 instances are equal
        /// </summary>
        /// <param name="input">Instance of SortBy3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SortBy3 input)
        {
            if (input == null)
            {
                return false;
