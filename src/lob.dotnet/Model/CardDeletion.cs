...
namespace lob.dotnet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "card_deletion")]
    public partial class CardDeletion : IEquatable<CardDeletion>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CardDeletion" /> class.
        /// </summary>
        ...
        /// <param name="_object">Value is type of resource. (default to ObjectEnum.CardDeleted).</param>
        public CardDeletion(string id = default(string), bool deleted = default(bool), ObjectEnum? _object = ObjectEnum.CardDeleted)
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as CardDeletion);
        }

        /// <summary>
        /// Returns true if CardDeletion instances are equal
        /// </summary>
        /// <param name="input">Instance of CardDeletion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CardDeletion input)
        {
            if (input == null)
            {
                return false;
