...
namespace lob.dotnet.Model
{
    ...
    /// BuckslipsList
    /// </summary>
    [DataContract(Name = "buckslips_list")]
    public partial class BuckslipsList : IEquatable<BuckslipsList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BuckslipsList" /> class.
        /// </summary>
        /// <param name="data">list of buckslips.</param>
        ...
        public BuckslipsList(List<Buckslip> data = default(List<Buckslip>), string _object = default(string), string nextUrl = default(string), string previousUrl = default(string), int count = default(int), int totalCount = default(int))
        {
            this.Data = data;
            this.Object = _object;
        ...
        /// list of buckslips
        /// </summary>
        /// <value>list of buckslips</value>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public List<Buckslip> Data { get; set; }
        ...
        {
            return this.Equals(input as BuckslipsList);
        }

        /// <summary>
        /// Returns true if BuckslipsList instances are equal
        /// </summary>
        /// <param name="input">Instance of BuckslipsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BuckslipsList input)
        {
            if (input == null)
            {
                return false;
