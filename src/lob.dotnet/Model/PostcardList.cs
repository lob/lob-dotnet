...
namespace lob.dotnet.Model
{
    ...
    /// PostcardList
    /// </summary>
    [DataContract(Name = "postcard_list")]
    public partial class PostcardList : IEquatable<PostcardList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostcardList" /> class.
        /// </summary>
        /// <param name="data">list of postcards.</param>
        ...
        {
            return this.Equals(input as PostcardList);
        }

        /// <summary>
        /// Returns true if PostcardList instances are equal
        /// </summary>
        /// <param name="input">Instance of PostcardList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostcardList input)
        {
            if (input == null)
            {
                return false;
