...
namespace lob.dotnet.Model
{
    ...
    /// AddressEditable
    /// </summary>
    [DataContract(Name = "address_editable")]
    public partial class AddressEditable : IEquatable<AddressEditable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressEditable" /> class.
        /// </summary>
        ...
        public AddressEditable(string addressLine1 = default(string), string addressLine2 = default(string), string addressCity = default(string), string addressState = default(string), string addressZip = default(string), CountryExtended addressCountry = default(CountryExtended), string description = default(string), string name = default(string), string company = default(string), string phone = default(string), string email = default(string), Dictionary<string, string> metadata = default(Dictionary<string, string>))
        {
        ...
        public CountryExtended AddressCountry { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressEditable {\n");
        ...
        {
            return this.Equals(input as AddressEditable);
        }

        /// <summary>
        /// Returns true if AddressEditable instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressEditable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressEditable input)
        {
            if (input == null)
            {
                return false;
